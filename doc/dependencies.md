...
These are the dependencies currently used by NewDeflacash. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/newdeflacashnl
Keybase  - https://keybase.io/team/newdeflacash/
